...
intel_845_reset(void *priv)
{
    ...
    intel_845_pam(0x90, dev);
    intel_845_pam(0x91, dev);
    intel_845_pam(0x92, dev);
    intel_845_pam(0x93, dev);
    intel_845_pam(0x94, dev);
    intel_845_pam(0x95, dev);
    intel_845_pam(0x96, dev);
...
const device_t intel_845_device = {
    .name          = "Intel i845 SDRAM (MCH) Chipset",
    .internal_name = "i845_sdr",
    .flags         = DEVICE_PCI,
    .local         = 0,
    .init          = intel_845_init,
...
const device_t intel_845_ddr_device = {
    .name          = "Intel i845 DDR (MCH) Chipset",
    .internal_name = "i845_ddr",
    .flags         = DEVICE_PCI,
    .local         = 1,
    .init          = intel_845_init,
    .close         = intel_845_close,
...
const device_t intel_845pe_device = {
    .name          = "Intel i845PE (MCH) Chipset",
    .internal_name = "i845pe",
    .flags         = DEVICE_PCI,
    .local         = 1,
    .init          = intel_845_init,
    .close         = intel_845_close,
