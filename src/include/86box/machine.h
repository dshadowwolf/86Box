...
enum {
    ...
    MACHINE_TYPE_SOCKET423  = 23,
    MACHINE_TYPE_SOCKET478  = 24,
    MACHINE_TYPE_LGA775     = 25,
    MACHINE_TYPE_SLOTA      = 26,
    MACHINE_TYPE_MISC       = 27,
    MACHINE_TYPE_MAX        = 28
};
...
/* m_at_socket478.c */
extern int machine_at_p4i45d_init(const machine_t *);
